...
namespace App\Application\Loan\CheckEligibility;

use OpenApi\Attributes as OA;
use Symfony\Component\Validator\Constraints as Assert;

#[OA\Schema(
    schema: "CheckLoanEligibilityRequestDto",
    description: "Запрос на проверку кредита",
    required: ["name", "amount", "rate", "startDate", "endDate"]
)]
class CheckLoanEligibilityRequestDto
{
